...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/tljh/user/bin',
 'BINLIBDEST': '/opt/tljh/user/lib/python3.7',
 'BLDLIBRARY': '-L. -lpython3.7m',
 'BLDSHARED': 'gcc -pthread -shared -B /opt/tljh/user/compiler_compat '
              '-L/opt/tljh/user/lib '
              '-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed '
              '-Wl,--sysroot=/',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /opt/tljh/user/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '-I/opt/tljh/user/include',
 'CONFIGURE_LDFLAGS': '-L/opt/tljh/user/lib '
                      '-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed '
                      '-Wl,--sysroot=/',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/opt/tljh/user' "
                "'--with-tcltk-includes=-I/opt/tljh/user/include' "
                "'--with-tcltk-libs=-L/opt/tljh/user/lib "
                "-ltcl8.6 -ltk8.6' "
                "'CPPFLAGS=-I/opt/tljh/user/include' "
                "'LDFLAGS=-L/opt/tljh/user/lib "
                "-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed -Wl,--sysroot=/' "
                "'PKG_CONFIG_PATH=/opt/tljh/user/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/opt/tljh/user/include',
 'CONFINCLUDEPY': '/opt/tljh/user/include/python3.7m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/opt/tljh/user/../work/Python-3.7.3/coverage.info',
 'COVERAGE_REPORT': '/opt/tljh/user/../work/Python-3.7.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/opt/tljh/user/include',
 'CXX': 'g++ -pthread -B /opt/tljh/user/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/opt/tljh/user '
             '/opt/tljh/user/lib '
             '/opt/tljh/user/lib/python3.7 '
             '/opt/tljh/user/lib/python3.7/lib-dynload',
 'DESTLIB': '/opt/tljh/user/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/opt/tljh/user/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/tljh/user/include '
                   '/opt/tljh/user/include '
                   '/opt/tljh/user/include/python3.7m '
                   '/opt/tljh/user/include/python3.7m',
 'INCLUDEDIR': '/opt/tljh/user/include',
 'INCLUDEPY': '/opt/tljh/user/include/python3.7m',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared -B /opt/tljh/user/compiler_compat '
                '-L/opt/tljh/user/lib '
                '-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed '
                '-Wl,--sysroot=/',
 'LDFLAGS': '-L/opt/tljh/user/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -B /opt/tljh/user/compiler_compat '
             '-L/opt/tljh/user/lib '
             '-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed '
             '-Wl,--sysroot=/',
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/opt/tljh/user/lib/python3.7',
 'LIBDIR': '/opt/tljh/user/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/tljh/user/lib/pkgconfig',
 'LIBPL': '/opt/tljh/user/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 'LIBRARY': 'libpython3.7m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -lutil -lrt',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'gcc -pthread -B /opt/tljh/user/compiler_compat -Wl,--sysroot/',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/tljh/user/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /opt/tljh/user/compiler_compat -Wl,--sysroot=/',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/tljh/user/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_CPPFLAGS': '-I. -I./Include '
                '-I/opt/tljh/user/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/tljh/user/lib '
               '-Wl,-rpath=/opt/tljh/user/lib -Wl,--no-as-needed '
               '-Wl,--sysroot=/',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/opt/tljh/user/../work/Python-3.7.3',
 'SCRIPTDIR': '/opt/tljh/user/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/opt/tljh/user/include',
 'TCLTK_LIBS': '-L/opt/tljh/user/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/opt/tljh/user/../work/Python-3.7.3 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/opt/tljh/user/../work/Python-3.7.3 '
 ...
 'abs_builddir': '/opt/tljh/user/../work/Python-3.7.3',
 'abs_srcdir': '/opt/tljh/user/../work/Python-3.7.3',
 'datarootdir': '/opt/tljh/user/share',
 'exec_prefix': '/opt/tljh/user',
 'prefix': '/opt/tljh/user',
 'srcdir': '.'}
